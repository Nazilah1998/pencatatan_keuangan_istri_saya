...
export const transactions = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can access their own transactions", {
      as: "permissive",
      for: "all",
      to: ["public"],
      using: sql`(auth.uid() = user_id)`,
    }),
    pgPolicy("Users can only see their own transactions", {
      as: "permissive",
      for: "all",
      to: ["public"],
    }),
    check(
      ...
      sql`jenis = ANY (ARRAY['pemasukan'::text, 'pengeluaran'::text])`,
    ),
  ],
);
...
export const budgets = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can access their own budgets", {
      as: "permissive",
      for: "all",
      to: ["public"],
      using: sql`(auth.uid() = user_id)`,
    }),
    pgPolicy("Users can only see their own budgets", {
      as: "permissive",
      for: "all",
      to: ["public"],
    }),
...
export const savings = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can access their own savings", {
      as: "permissive",
      for: "all",
      to: ["public"],
      using: sql`(auth.uid() = user_id)`,
    }),
    pgPolicy("Users can only see their own savings", {
      as: "permissive",
      for: "all",
      to: ["public"],
    }),
...
export const assets = pgTable(
  "assets",
  {
    ...
    tanggalUpdate: date("tanggal_update")
  ...
  (table) => [
    ...
    pgPolicy("Users can access their own assets", {
      as: "permissive",
      for: "all",
      to: ["public"],
      using: sql`(auth.uid() = user_id)`,
    }),
    pgPolicy("Users can only access their own assets", {
      as: "permissive",
      for: "all",
      to: ["public"],
    }),
    pgPolicy("Users can only see their own assets", {
      as: "permissive",
      for: "all",
      to: ["public"],
    }),
...
export const debts = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can access their own debts", {
      as: "permissive",
      for: "all",
      to: ["public"],
      using: sql`(auth.uid() = user_id)`,
    }),
    pgPolicy("Users can only access their own debts", {
      as: "permissive",
      for: "all",
      to: ["public"],
    }),
    pgPolicy("Users can only see their own debts", {
      as: "permissive",
      for: "all",
      to: ["public"],
    }),
